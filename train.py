...
def get_args_parser():
    ...
    parser.add_argument('--data_root', default='./data/SCCD/part_A_final',
    ...
    parser.add_argument('--tensorboard_dir', default='./run_photo',
                        help='path where to save, empty for no saving')
...
def main(args):
    ...
    param_dicts = [
        {"params": [p for n, p in model_without_ddp.named_parameters(SSS) if "backbone" not in n and p.requires_grad]},
        {
